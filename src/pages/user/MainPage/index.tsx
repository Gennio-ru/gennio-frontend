    ...
    <div className="w-full flex flex-col items-center mt-[70px] sm:mt-[120px]">
      ...
      <GlassCard className="max-w-lg lg:max-w-full mx-auto w-full mt-[95px] sm:p-8 relative">
        ...
        <div className="max-w-[500px] max-[400px]:mt-[-130px] mt-[-150px] lg:mt-0">
          ...
          <p className="mt-3">
            Изменяйте своё изображение по собственным текстовым запросам — от
            лёгкой корректировки до полной трансформации:
          </p>
          ...
          <ul className="mt-3.5 list-disc pl-5 space-y-1">
            ...
            <li className="pl-1">Перемещайте объект в любое пространство</li>
          </ul>
      ...
      <GlassCard className="mt-20 lg:mt-10 max-w-lg lg:max-w-full mx-auto w-full sm:p-8 relative">
        ...
        <div className="max-w-[500px] max-[400px]:mt-[-130px] mt-[-150px] lg:mt-0 lg:ml-auto">
          ...
          <p className="mt-3">
            При желании вы можете добавить свои детали: изменить позу, сделать
            портрет во весь рост, поменять цвет волос или уточнить любые мелкие
            особенности
          </p>
